...
describe('Remove Todo', () => {
  test('Adding TODO Four to local storage and deleting it', () => {
    const todo1 = new Todo(1, 'Item One');
    todo1.addTodo();
    const todo2 = new Todo(2, 'Item Two');
    todo2.addTodo();
    const delIndex = todo1.index;
    todo1.removeTodo(delIndex);
    ...
    const deletedItem = data.filter(removeItem(todo1.description));
