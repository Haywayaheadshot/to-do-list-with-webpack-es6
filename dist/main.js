...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _images_icons_refresh_png__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./images/icons/refresh.png */ \"./src/images/icons/refresh.png\");\n/* harmony import */ var _images_icons_enter_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./images/icons/enter.png */ \"./src/images/icons/enter.png\");\n/* harmony import */ var _images_icons_delete_png__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./images/icons/delete.png */ \"./src/images/icons/delete.png\");\n/* harmony import */ var _images_icons_edit_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./images/icons/edit.png */ \"./src/images/icons/edit.png\");\n/* harmony import */ var _js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./js/modules/Variables.js */ \"./src/js/modules/Variables.js\");\n\n// import refresh from imgages\n\n// import enter from images\n\n// import delete from images\n\n// import edit from images\n\n\n// import variables from variables.js\n\n\n_js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__.refreshButton.src = _images_icons_refresh_png__WEBPACK_IMPORTED_MODULE_1__;\n_js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__.refreshButton.classList.add('refresh-img');\n// Append refresh button to the DOM\n_js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__.refresh.appendChild(_js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__.refreshButton);\n_js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__.enterButton.src = _images_icons_enter_png__WEBPACK_IMPORTED_MODULE_2__;\n_js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__.enterButton.classList.add('enter-img');\n// Append enter button to the DOM\n_js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__.submit.appendChild(_js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__.enterButton);\n\n// Class for task\nclass TaskConstructor {\n  constructor(index, description, completed) {\n    this.index = index;\n    this.description = description;\n    this.completed = completed;\n  }\n}\n\nclass Task {\n  constructor() {\n    this.listArray = JSON.parse(localStorage.getItem('books')) || [];\n  }\n\n  addNewTask = (index = null, description = null, completed = null) => {\n    if (description) {\n      const newTaskIndex = index || this.listArray.length + 1;\n      const isNewTaskCompleted = completed || false;\n      const newTask = new TaskConstructor(newTaskIndex, description, isNewTaskCompleted);\n      this.listArray.push(newTask);\n      localStorage.setItem('tasks', JSON.stringify(this.listArray));\n      return newTask;\n    }\n\n    return null;\n  };\n}\n\nconst newTask = new Task();\n\nconst createTaskDynamically = () => {\n  const task = newTask.addNewTask(null, _js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__.input.value, false);\n  const li = document.createElement('li');\n  li.classList.add('to-do-list-item');\n  _js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__.toDoList.appendChild(li);\n  const checkBox = document.createElement('input');\n  checkBox.setAttribute('type', 'checkbox');\n  checkBox.setAttribute('class', 'checkbox');\n  checkBox.setAttribute('id', `checkbox-${task.index}`);\n  checkBox.setAttribute('unchecked', `${task.completed ? 'checked' : ''}`);\n  li.appendChild(checkBox);\n  const checkBoxLabel = document.createElement('label');\n  checkBoxLabel.setAttribute('for', `checkbox-${task.index}`);\n  checkBoxLabel.setAttribute('class', 'checkbox-label');\n  checkBoxLabel.innerHTML = task.description;\n  li.appendChild(checkBoxLabel);\n  const editButton = document.createElement('button');\n  editButton.setAttribute('class', 'edit-button');\n  editButton.setAttribute('type', 'button');\n  editButton.innerHTML = `<img class=\"edit-image\" src='${_images_icons_edit_png__WEBPACK_IMPORTED_MODULE_4__}' alt=\"Edit Button\">`;\n  li.appendChild(editButton);\n  const deleteButton = document.createElement('button');\n  deleteButton.setAttribute('class', 'delete-button');\n  deleteButton.setAttribute('type', 'button');\n  deleteButton.innerHTML = `<img class=\"delete-image\" src='${_images_icons_delete_png__WEBPACK_IMPORTED_MODULE_3__}' alt=\"Delete Button\">`;\n  li.appendChild(deleteButton);\n  _js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__.input.value = '';\n  // get the list from local storage\n  localStorage.getItem('tasks');\n};\n\ndocument.addEventListener('DOMContentLoaded', createTaskDynamically.displayTasks);\n\n// event listener for enter button\n_js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__.submit.addEventListener('click', (event) => {\n  event.preventDefault();\n  if ((_js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__.input.value !== '') || (event.key === 'Enter')) {\n    createTaskDynamically();\n  } else if (_js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__.input.value === '') {\n    _js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__.errorMessage.style.display = 'block';\n    setTimeout(() => {\n      _js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__.errorMessage.style.display = 'none';\n    }, 1500);\n  }\n});\n\n// Event listener for refresh button\n_js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__.refresh.addEventListener('click', (event) => {\n  event.preventDefault();\n  window.location.reload();\n  _js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__.toDoList.style.display = 'block';\n  // get the list from local storage\n  // createTaskDynamically();\n  // localStorage.getItem('tasks');\n  // const myData = localStorage.getItem('tasks');\n  // console.log(myData);\n});\n\nwindow.addEventListener('load', () => {\n  const myData = localStorage.getItem('tasks');\n  // get the list from local storage\n  // loop through myData\n  // for (let i = 0; i < myData.length; i += 1) {\n  //   console.log(myData[i]);\n  // }\n  const li = document.createElement('li');\n  li.classList.add('to-do-list-item');\n  _js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__.toDoList.appendChild(li);\n  const checkBox = document.createElement('input');\n  checkBox.setAttribute('type', 'checkbox');\n  checkBox.setAttribute('class', 'checkbox');\n  checkBox.setAttribute('id', `checkbox-${myData.index || 0}`);\n  checkBox.setAttribute('unchecked', `${myData.completed ? 'checked' : ''}`);\n  li.appendChild(checkBox);\n  const checkBoxLabel = document.createElement('label');\n  checkBoxLabel.setAttribute('for', `checkbox-${myData.index}`);\n  checkBoxLabel.setAttribute('class', 'checkbox-label');\n  checkBoxLabel.innerHTML = myData.description;\n  li.appendChild(checkBoxLabel);\n  const editButton = document.createElement('button');\n  editButton.setAttribute('class', 'edit-button');\n  editButton.setAttribute('type', 'button');\n  editButton.innerHTML = `<img class=\"edit-image\" src='${_images_icons_edit_png__WEBPACK_IMPORTED_MODULE_4__}' alt=\"Edit Button\">`;\n  li.appendChild(editButton);\n  const deleteButton = document.createElement('button');\n  deleteButton.setAttribute('class', 'delete-button');\n  deleteButton.setAttribute('type', 'button');\n  deleteButton.innerHTML = `<img class=\"delete-image\" src='${_images_icons_delete_png__WEBPACK_IMPORTED_MODULE_3__}' alt=\"Delete Button\">`;\n  li.appendChild(deleteButton);\n});\n\n// event listener for clear completed button\n_js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__.clearCompletedButton.addEventListener('click', (event) => {\n  event.preventDefault();\n  const completedTasks = document.querySelectorAll('.completed');\n  completedTasks.forEach((task) => {\n    task.remove();\n  });\n});\n\n// event listener for delete button\n_js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__.toDoList.addEventListener('click', (event) => {\n  if (event.target.className === 'delete-image') {\n    // remove task from the DOM\n    event.target.parentElement.parentElement.remove();\n    // remove task from local storage\n    // const taskIndex = event.target.parentElement.parentElement.children[0].id;\n    // const taskIndexNumber = taskIndex.split('-')[1];\n    // const tasks = JSON.parse(localStorage.getItem('tasks'));\n    // tasks.splice(taskIndexNumber - 1, 1);\n    // localStorage.setItem('tasks', JSON.stringify(tasks));\n  }\n  if (event.target.className === 'edit-image') {\n    const editButton = event.target.parentElement;\n    const editTask = editButton.previousElementSibling;\n    const editTaskText = editTask.textContent;\n    editTask.innerHTML = `\n        <input type=\"text\" class=\"edit-input\" value=\"${editTaskText}\" >\n        `;\n    const editInput = editTask.querySelector('.edit-input');\n    editInput.addEventListener('keydown', (event) => {\n      if ((event.key === 'Enter') && (editInput.value !== '')) {\n        event.preventDefault();\n        editTask.innerHTML = editInput.value;\n      } else if ((event.key === 'Enter') && (editInput.value === '')) {\n        // show error message\n        _js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__.errorMessage.style.display = 'block';\n        setTimeout(() => {\n          _js_modules_Variables_js__WEBPACK_IMPORTED_MODULE_5__.errorMessage.style.display = 'none';\n        }, 3000);\n      }\n    });\n  }\n  if (event.target.type === 'checkbox') {\n    // mark task as completed\n    if (event.target.checked) {\n      event.target.parentElement.classList.add('completed');\n    } else {\n      event.target.parentElement.classList.remove('completed');\n    }\n  }\n});\n\n//# sourceURL=webpack://to-do-list-with-webpack-es6/./src/index.js?");
